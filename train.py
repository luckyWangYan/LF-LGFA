...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='LF-LGFA')
    parser.add_argument('--trainset_dir', type=str, default='./data/TrainingData/4xSR_5x5/')
    parser.add_argument('--testset_dir', type=str, default='./data/TestingData/4xSR_5x5/')
    ...
    parser.add_argument('--model_path', type=str, default='./pth/LF_LGFA_4SR.pth.tar')
